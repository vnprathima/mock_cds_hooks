...
def create_stub(response_body):
    ...
    print(f"OPTIONS stub for cdex/Claim/$inquire created successfully")

    url = "{}/__admin/mappings".format(wiremock_base_url)
    response = requests.post(url, json=mapping)
    response.raise_for_status()
    print(f"POST stub for cdex/Claim/$inquire created successfully")
            ...
            "entry": [
                {
                    "resource": {
                        ...
                        "communicationRequest" : [
                            {
                                "reference":"#CommunicationRequestExample"
                            }
                        ],
